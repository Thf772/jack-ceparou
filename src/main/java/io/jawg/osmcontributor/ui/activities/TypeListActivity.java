...
import io.jawg.osmcontributor.ui.utils.views.HorizontalViewSwitcher;
import io.jawg.osmcontributor.ui.presenters.TypeListActivityPresenter;
import io.jawg.osmcontributor.ui.adapters.PoiTypeAdapter;
import io.jawg.osmcontributor.ui.adapters.PoiTypeTagAdapter;
import io.jawg.osmcontributor.utils.helper.DragSwipeItemTouchHelperCallback;
...
public class TypeListActivity extends AppCompatActivity implements PoiTypeTagAdapter.OnStartDragListener {
    ...
    public void showTypes(List<PoiType> poiTypes) {
        showingTypes = true;
    ...
    public void showTags(Collection<PoiTypeTag> poiTypeTags, PoiType poiType) {
        showingTypes = false;
